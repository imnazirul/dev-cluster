  ...
  return (
    <div className="flex items-center h-[60vh] justify-center w-screen">
      <div>
        ...
        <button className="disabled:cursor-not-allowed w-full flex  items-center  jus border mb-4 md:px-8  px-1 py-2 hover:shadow-xl  rounded-lg font-semibold cursor-pointer">
          <FcGoogle size={40} />
